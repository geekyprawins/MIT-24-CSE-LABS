...
int main()
{
    ...
    for (arr[3] = (sign == 1) ? 0 : 9;; arr[3] = (arr[3] + sign + 10) % 10)
        for (arr[2] = (sign == 1) ? 0 : 9; arr[2] >= 0 && arr[2] <= 9; arr[2] += sign)
            for (arr[1] = (sign == 1) ? 0 : 9; arr[1] >= 0 && arr[1] <= 9; arr[1] += sign)
                for (arr[0] = (sign == 1) ? 0 : 9; arr[0] >= 0 && arr[0] <= 9; arr[0] += sign)
                {
